...
export default function Home() {
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own any PDPkrypto test NFTs. <br />
  ...
  return (
    <div>
      <Head>
        <title>PDPkrypto test DAO</title>
        <meta name="description" content="PDPkrypto test DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to PDPkrypto test DAO!</h1>
          <div className={styles.description}>
            Welcome to PDPkrypto test DAO!
          </div>
          <div className={styles.description}>
            Your PDPkrypto test NFT Balance: {nftBalance}
            <br />
